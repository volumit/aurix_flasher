...
AS_FLAGS = -mtc161
LINKER_FLAGS= -v --mcpu=tc161 -T flash_TC2xx.ld -nostartfiles -nostdlib -nodefaultlibs
LIBS= 

LIBRARY_PATH= 

EXECUTEABLE= flash_TC2xx.elf
SREC= flash_TC2xx.sre
IHEX= flash_TC2xx.hex
DISASM= DisAsm_flash_TC2xx.Lst


$(EXECUTEABLE): $(OBJS) flash_TC2XX.ld 
...
flash_TC2xx.o: flash_TC2xx.c
	@echo 'Building file: $<'
	@echo 'Invoking: Compiler'
	$(CC) -S $(CC_FLAGS) -c $<  
	$(AS) $(AS_FLAGS) flash_TC2xx.s  -o flash_TC2xx.o
...
clean:
	-rm -f flash_TC2xx.elf
	-rm -f flash_TC2xx.o
	-rm -f flash_TC2xx.i
	-rm -f flash_TC2xx.sre
	-rm -f flash_TC2xx.hex
